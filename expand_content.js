        ...
        <div className="services-grid">
          ...
          <Card interactive title="Cuentas de Ahorro Premium" description="Haz crecer tu patrimonio. Tasa de inter\u00E9s escalonada hasta un 5% anual y cero comisiones de manejo.">
             ...
             <div className="card-footer">
               <span className="text-sm font-semibold">\u00A1Abrela en l\u00EDnea!</span>
             </div>
          </Card>
          ...
          <Card interactive title="Tarjetas Sin L\u00EDmites" description="Cashback ilimitado en supermercados, gasolineras y farmacias. \u00A1Sin costo de emisi\u00F3n por el primer a\u00F1o!">
             <div className="card-icon-wrapper text-accent">
               <CreditCard size={48} strokeWidth={1.5} />
             </div>
             <div className="card-footer">
               <span className="text-sm font-semibold">Solic\u00EDtala ya</span>
             </div>
          </Card>
          ...
          {/* Card 3 - Pr\u00E9stamos */}
           <Card interactive title="Pr\u00E9stamos Flexibles" description="Aprobaci\u00F3n inmediata. Hasta 60 meses para pagar y la tasa m\u00E1s competitiva del mercado.">
             ...
             <div className="card-footer">
               <span className="text-sm font-semibold">Calcula tu cuota</span>
             </div>
          </Card>
      ...
      <section className="app-section">
        <div className="container app-content">
          <div className="app-text">
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1.5rem' }}>Tu Banco en tu Bolsillo</h2>
            <ul style={{ listStyle: 'none', padding: 0, fontSize: '1.1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <li style={{display: 'flex', alignItems: 'center', gap: '0.5rem'}}><Smartphone className="text-accent" /> Pago de servicios e impuestos al instante.</li>
              <li style={{display: 'flex', alignItems: 'center', gap: '0.5rem'}}><ShieldCheck className="text-accent" /> Control total de tus tarjetas (bloqueo/desbloqueo).</li>
              <li style={{display: 'flex', alignItems: 'center', gap: '0.5rem'}}><Percent className="text-accent" /> Ofertas exclusivas por geolocalizaci\u00F3n.</li>
            </ul>
...
.app-section {
  background-color: var(--color-bg-body); /* Changed to use variable */
